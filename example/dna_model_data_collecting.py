...
def main():
    ...
    poff_list = np.arange(0, 0.01, 0.0025)
    for p_off in poff_list:
        for kn1 in kn1_list:
            for kn2 in kn2_list:
...
def submain1(kn1, kn2, p_off):
    ...
    for km, kp in kmkppair:
        one_var_tracker, one_var_last_week_hst, one_var_pack = submain(kp, km, kn1, ka1, kn2, ka2, p_off)
...
def submain(k_plus, k_minus, kn1, ka1, kn2, ka2, p_off):
    ...
    for ex in range(example_n):
        one_var_m[ex], one_var_hst_list[ex], one_var_pack[ex] = subsubmain(k_plus=k_plus,
                                                                           k_minus=k_minus,
                                                                           k_nuc1=kn1,
                                                                           k_ace1=ka1,
                                                                           k_nuc2=kn2,
